if (typeof window !== "undefined" && !window.famobi_tracking) {
    !function(a, b) {
        ...
        /*
            Famobi Tracking - JS Client Module
            ver 1.1.3
        */

        var tracking = {
            endpointUrl: 'https://master.tracking.html5games.com/',
            game: '',
        ...
        function init(game, preferredUid, clientVersion, debug, trackAds) {
            ...
            if (trackAds && window.hasOwnProperty('famobi') && window.famobi.hasOwnProperty('adapters')) {
